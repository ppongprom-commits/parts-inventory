...
// แก้ path ที่ผิด (ของเดิมจากต้นทางชี้ไปที่ tests/test-assets/tiny.png ซึ่งไม่มีอยู่จริง — ไฟล์จริง
// อยู่ที่ fixtures/test-assets/tiny.png คนละที่กับที่ path เดิมคำนวณ ทุก test ในไฟล์นี้จะโยน
// ENOENT ทันทีที่รันจริงถ้าไม่แก้) ตรวจสอบแล้วว่า qa-automation/fixtures/test-assets/tiny.png มีอยู่จริง
